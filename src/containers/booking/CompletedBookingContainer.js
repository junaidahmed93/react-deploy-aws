...
class BookingContainer extends Component {
  constructor(props) {
    ...
    this.statuses = ['All', 'Cancelled', 'Completed'];
  }
  ...
  componentWillReceiveProps(nextProps) {
    ...
    setTimeout(() => {
      ...
      // if (this.completedBookings.length != this.state.storedRecords.length) {
  ...
  handlerSearch = () => {
    ...
    this.setState({
      showSearchbar: true, showFilterBar: false, showTagBar: false, open: false,
    });
  }
          ...
          <Grid fluid className="container-no-padding">
            <Row between="xs">
              <Col xs={4} style={GlobalStyle.containerHeader}>
                <h2 className="paper-title">Bookings Completed</h2>
              </Col>
              <Col xs={8} >
          ...
          <Grid fluid className="container-no-padding">
            ...
            <Row>
              ...
              <Col md={3} className="filterSelect">
                ...
                >
                  {this.statuses.map(v => <MenuItem value={v} primaryText={v.replace('-', ' ')} key={v} />)}
                </SelectField>
              </Col>
              <Col md={3} />
              <Col md={3}>
